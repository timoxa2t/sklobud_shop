...
import {addToCart} from '../store/actions/goods'
...
export default function GoodsItem(props){
  ...
  const {id, name, price, description, img, inCart} = props.details
          ...
          <div className="row">
            <div className="col-12 col-lg-4">
              ...
              {price > 0 &&
                ...
                <InputGroup className="pb-3 ps-2 pe-2">
                  <FormControl
                  ...
                  <Button
                    ...
                    onClick={handleClick}>
                      {inCart ?
                        ...
                        (<><i className="fas fa-cart-plus "/> Додати в кошик</>)
                      }
                  </Button>
                </InputGroup>
                </>
